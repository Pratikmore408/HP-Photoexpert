...
function Cart() {
  ...
  // State variables for total amount, name, address, pincode, and phone number
  ...
  // Constants for shipping cost and grand total
  ...
  const buyNow = async () => {
    ...
    // Further logic for buy now action
    const addressInfo = {
      name,
      address,
      pincode,
  ...
  // JSX structure for displaying cart items, subtotal, shipping, and total
