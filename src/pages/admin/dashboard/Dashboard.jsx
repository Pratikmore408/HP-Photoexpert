...
import { FaUserTie, FaShoppingBag, FaRupeeSign } from "react-icons/fa";
...
function Dashboard() {
  // Accessing context to get mode
  const context = useContext(myContext);
  const { mode, product, user, order } = context;

  return (
    // Layout component wrapping the dashboard section
    <Layout>
      <section className="text-gray-600 body-font mt-10 mb-10">
        <div className="container px-5 mx-auto mb-10">
          <div className="flex flex-wrap -m-4 text-center">
            ...
            {/* Dashboard card for total orders */}
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div
                className="border-2 hover:shadow-purple-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300 px-4 py-3 rounded-xl"
                style={{
            ...
            {/* Dashboard card for total users */}
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div
                className="border-2 hover:shadow-purple-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300 px-4 py-3 rounded-xl"
                style={{
            ...
            {/* Dashboard card for another metric */}
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div
                className="border-2 hover:shadow-purple-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] bg-gray-100 border-gray-300 px-4 py-3 rounded-xl"
                style={{
